...
from eval.utils import (
    ...
    load_dexperts_model_and_tokenizer2,
)
...
def main(args):
    ...
    elif args.expert_model_name_or_path_2:
        print("Loading model and tokenizer expert2...")
        model, tokenizer = load_dexperts_model_and_tokenizer2(
            args.base_model_name_or_path,
            args.expert_model_name_or_path,
            args.expert_model_name_or_path_2,
            args.expert_model_name_or_path_3,
            load_in_8bit=args.load_in_8bit,
            use_fast_tokenizer=not args.use_slow_tokenizer,
        )
    elif args.base_model_name_or_path:
        print("Loading model and tokenizer expert...")
    ...
    test_df = pd.read_json(os.path.join(args.data_dir, "sampled_dev.jsonl"), lines=True)
