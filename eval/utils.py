...
def load_dexperts_model_and_tokenizer2(
    base_model_name_or_path: str,
    expert_model_name_or_path: str,
    ...
    from transformers import AutoTokenizer
    from modeling.dexperts2 import DExpertsLlama2
    ...
    model = DExpertsLlama2(
        base_model_name_or_path=base_model_name_or_path,
        expert_model_name_or_path=expert_model_name_or_path,
        expert_model_name_or_path_2=expert_model_name_or_path_2,
        expert_model_name_or_path_3=expert_model_name_or_path_3,
        antiexpert_model_name_or_path=antiexpert_model_name_or_path,
        tokenizer=tokenizer,
        system_prompt=system_prompt,
        alpha=alpha,
