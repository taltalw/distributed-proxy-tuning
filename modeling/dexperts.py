    ...
    def generate(
        ...
        **kwargs
        ...
        for step in range(max_new_tokens):
            ...
            # if "past_key_values" in base_kwargs:
            #     print("past_key_values type:", type(base_kwargs["past_key_values"]))
            #     print("past_key_values:", base_kwargs["past_key_values"])

            # base_kwargs["past_key_values"] = tuple()
            # expert_kwargs["past_key_values"] = tuple()
            # antiexpert_kwargs["past_key_values"] = tuple()
            ...
            # stopping criteria
            # result = stopping_criteria(input_ids, None)
            # print(type(result), result.shape if isinstance(result, torch.Tensor) else result)
